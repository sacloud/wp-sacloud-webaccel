...
## 目次
	...
	- [事前準備](#事前準備)
		- [APIキー発行](#apiキー発行)
		- [さくらのウェブアクセラレータ設定](#さくらのウェブアクセラレータ設定)
...
各項目は以下のように入力してください。
	...
	- 説明 : 任意入力
	- アクセスレベル : 「無効」以外の項目を選択
	- 他サービスへのアクセス権 : さくらのウェブアクセラレータにチェックを入れる
...
サブドメイン型でさくらのウェブアクセラレータを利用する場合、サブドメイン名をWordPress管理画面にて入力する必要があります。
サブドメイン名は以下の手順で確認します。

さくらのクラウドコントロールパネルから、「さくらのウェブアクセラレータ」を選択します。
