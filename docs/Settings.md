...
左のメニューから「設定」、「さくらのウェブアクセラレータ」を選択します。

![setting-01.png](images/setting-01.png)

「さくらのウェブアクセラレータ設定」画面が表示されます。必要情報を入力していきます。
...
さくらのウェブアクセラレータへのアクセス権が設定されていない場合は以下のようなメッセージになります。
...
さくらのウェブアクセラレータでのキャッシュについての設定を行います。

### ドメイン

![subdomain.png](images/subdomain.png)

サブドメイン型でさくらのウェブアクセラレータを利用する場合に設定します。
(独自ドメイン型の場合は設定不要です)
